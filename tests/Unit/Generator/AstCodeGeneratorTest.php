...
class AstCodeGeneratorTest extends TestCase
{
...
class App {
    ...
    public function testGeneratePreservesFilePermissions(): void
    {
        ...
        $this->assertTrue(($perms & 0100) !== 0); // Owner execute permission
    }
...
class App {
    ...
    public function setProperty(string $value): void {
        ...
        // 验证普通注释被移除
        $this->assertStringNotContainsString('Regular comment', $content);
        $this->assertStringNotContainsString('Internal comment', $content);
